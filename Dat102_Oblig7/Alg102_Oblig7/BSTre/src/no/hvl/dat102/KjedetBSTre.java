 ...
 *********************************************************************/
 ...
 public int hoyde(){
	...
	private int hoyde(BinaerTreNode<T> aNode){
	    int hoydeVenstre = 0;
	    int hoydeHoyre = 0;
	    if(aNode.getVenstre()!=null) 
	        hoydeVenstre = hoyde(aNode.getVenstre());
	    if(aNode.getHoyre()!=null)
	        hoydeHoyre = hoyde(aNode.getHoyre());
	    if(hoydeVenstre > hoydeHoyre){
	        return hoydeVenstre+1;
	    }
	    else{
	        return hoydeHoyre+1;
	    }
